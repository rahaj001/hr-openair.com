...
export default function Kontakt() {
  ...
  const API_KEY_CAPTCHA = import.meta.env.VITE_API_KEY_CAPTCHA; // dein reCAPTCHA SITE-KEY
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ Token vom Invisible reCAPTCHA holen
    ...
    <div className="page">
      ...
      <form className="contact-form" onSubmit={handleSubmit}>
        ...
        <textarea
          ...
          required
        />
        {/* reCAPTCHA invisible (kein sichtbarer Button, Token wird geholt) */}
